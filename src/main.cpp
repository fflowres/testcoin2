...
uint256 hashGenesisBlock("0x07516991a5935411cacf6721bd1c4d1bee707d5b25adf5c4617475ab5ad96b1e");
...
const string strMessageMagic = "TooCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // TooCoin: 1 days
static const int64 nTargetSpacing = 120; // TooCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal toocoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TooCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x08b7d7c2bc4480a3fb55b9ce9c15e67dc0cc73194caa3ba329d3f5b2d87c8b93");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "EATING SOME BLOODY SPAGHETTI";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1383967247; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1155445;
        ...
        assert(block.hashMerkleRoot == uint256("0xfd2026bb3bdf03920023fe91dd44ef00ad2f9b0568446d452ec97e1d1bed6bd3"));
